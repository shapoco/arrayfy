...
import * as Preproc from './Preprocessor'
import * as Quantizer from './Reducer'
...
let quantizedImage: QuantizedImage|null = null;
...
function convert(): void {
  ...
  try {
    ...
    // 減色の適用
    {
      ...
      // 減色
      const args = new Quantizer.Arguments();
      args.src = norm;
      args.format = fmt;
